package io.vectorsync.embeddingworker.config;
...
/**
 * Configuration for Iceberg catalog used by embedding worker.
 */
...
public class IcebergConfig {
    ...
    public Catalog icebergCatalog() {
        ...
        return CatalogUtil.loadCatalog(catalogImpl, "iceberg-catalog", properties, hadoopConf);
    }
